...
public class DlgCekSKDPKontrol extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NoKartuPasien = new component.TextBox();
        ...
        NoKartuPasien.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 131, 62), 2, true));
        NoKartuPasien.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        NoKartuPasien.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        NoKartuPasien.setPreferredSize(new java.awt.Dimension(350, 75));
        NoKartuPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NoKartuPasienActionPerformed(evt);
            }
        });
        NoKartuPasien.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NoKartuPasienKeyPressed(evt);
            }
        });
        ...
        jPanel1.add(NoKartuPasien, gridBagConstraints);
    ...
    private void NoKartuPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoKartuPasienActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NoKartuPasienActionPerformed

    private void NoKartuPasienKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoKartuPasienKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (Sequel.cariInteger("select count(pasien.no_peserta) from pasien where pasien.no_peserta='" + NoKartuPasien.getText() + "'") > 0) {
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                DlgRegistrasiSEPPertama form = new DlgRegistrasiSEPPertama(null, true);
//                form.tampilKontrol(NoKartuPasien.getText());
                form.tampil(NoKartuPasien.getText());
    ...
    }//GEN-LAST:event_NoKartuPasienKeyPressed
...
//            form.tampilKontrol(NoKartuPasien.getText());
    ...
    private component.TextBox NoKartuPasien;
