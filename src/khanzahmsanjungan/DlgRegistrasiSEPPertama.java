...
public class DlgRegistrasiSEPPertama extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2023" }));
        ...
        TanggalRujuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2023" }));
        ...
        TanggalKKL.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-07-2023" }));
        ...
        try {
            ...
            if (nameNode.path("code").asText().equals("200")) {
                ...
                if (Sequel.menyimpantf2("reg_periksa", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 19,
                        new String[]{"W"+NoReg.getText(), TNoRw.getText(), Valid.SetTgl(TanggalSEP.getSelectedItem() + ""), Sequel.cariIsi("select current_time()"),
...
//                NoSKDP.setText(response.path);
                ...
                NoSKDP.setText(Sequel.cariIsi("select bridging_surat_kontrol_bpjs .no_surat from bridging_surat_kontrol_bpjs inner join bridging_sep on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep where bridging_sep.no_kartu='" + NoKartu.getText() + "' and bridging_surat_kontrol_bpjs.tgl_rencana=current_date()"));
...
//                }
                ...
                Kdpnj.setText("BPJ");
                nmpnj.setText("BPJS");
                Catatan.setText("Anjungan Mandiri RSUD Sultan Imannuddin Pangkalan Bun");
                ps = koneksi.prepareStatement(
...
//                }
                ...
                Kdpnj.setText("BPJ");
                nmpnj.setText("BPJS");
                Catatan.setText("Anjungan Mandiri Anjungan Mandiri RSUD Sultan Imannuddin Pangkalan Bun");
